...
// Ball Memory: [x, y, vx, vy, mass, friction]
export const BALL_STRIDE = 6;
export const BALL_OFFSET_X = 0;
export const BALL_OFFSET_Y = 1;
export const BALL_OFFSET_VX = 2;
export const BALL_OFFSET_VY = 3;
export const BALL_OFFSET_MASS = 4;
export const BALL_OFFSET_FRICTION = 5;
